                            ...
                            children: widget.product.images!.map((url) {
                              ...
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: _current == index ? AppTheme.grey900 : AppTheme.grey300,
                                ),
                              );
                            }).toList(),
                          ),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(child: Text(widget.product.title!,style: Theme.of(context).textTheme.displaySmall?.copyWith(color: AppTheme.grey900,overflow: TextOverflow.ellipsis),maxLines: 1,)),
                      GestureDetector(
                        onTap: (){
                  ...
                  Row(
                    children: [
                      ...
                      SvgPicture.asset(widget.product.rating==5?"assets/icons/FullStar.svg":"assets/icons/HalfStar.svg"),
                      const SizedBox(width: 8),
                      Text(widget.product.rating.toString(),style: AppTheme.bodyMediumMedium.copyWith(color: AppTheme.grey700),)
